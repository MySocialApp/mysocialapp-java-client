...
class ConversationTest {
    ...
    private fun getSession(): Session? = MySocialApp.Builder().setAppId(APP_ID).setAPIEndpointURL("http://localhost:8080").build().blockingConnect("AliceX", "myverysecretpassw0rd")
